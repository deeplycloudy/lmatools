...
flashes_in_poly = TimeSeriesPolygonFlashSubset(h5_filenames, 
                        t_start, t_end, dt, 
...
grid_ranges = ((1, 1000), (1,100), (1, 100000),  (1, 100000.0), (1,1000), (1, 100000), (1e6, 1e12))
field_ids_to_run = (0, 1, 2, 3, 4, 5, 6)
